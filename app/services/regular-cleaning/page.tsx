...
const RegularCleaning: React.FC = () => {
 const includedServices = [
  ...
  {
    title: 'Laundry',
    image: '/images/laundryRoomImg.jpg',
    items: [
      'Wipe appliances',
      'Sink cleaned',
      'Mop floors',
    ...
    <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6 text-left">
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="w-24 h-1 bg-emerald-500 mx-auto mb-6"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experience the life-changing benefits of consistent professional cleaning
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              When to Book Regular Cleaning
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Perfect for these lifestyles and situations
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 leading-relaxed">
              Join thousands of happy clients enjoying professional regular cleaning
            </p>
            <Link href="/book">
              <motion.button
