...
const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 bg-white border-b border-emerald-100`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className={`hidden md:flex items-center space-x-2 text-sm text-gray-700`}>
            ...
            <a href="tel:+61435137936" className="transition-colors duration-200 hover:text-emerald-600">
              +61 435 137 936
            </a>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-md transition-colors duration-200 text-gray-700 hover:text-emerald-600"
            >
            ...
            <div className="px-4 py-6 space-y-1 min-h-full">
              {navigation.map((item) => (
                <div key={item.name}>
                  <Link
                    href={item.href}
                    className={`block px-3 py-3 text-base font-medium transition-colors duration-200 rounded-lg ${pathname === item.href
                      ? 'text-emerald-600'
